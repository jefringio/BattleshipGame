...
public class BattleShip{
	...
	public static void main(String[] args){
		...
		String[] guess;
		int x=-1,y=-1; //initialize to -1 or else compiler complains that it is not intialized while going through
		// the try block
		...
		System.out.println("Please enter x and y coordinates (max coordinate of " + (board.layout.length-1)+ ") you would " +
				"like to hit!\n");
		board.displayBoard();
