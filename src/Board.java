...
// And a Board class that stores the data the game in general. It will have an array of Ship objects,
// and an ArrayList of points that represent the player's guesses.
// driver program
public class Board{
	String[][] layout;
	private Ship[] ships;
	...
	public Board(){
		...
		xLength =8;
		yLength =8;
		int numShips = 3; //create 5 ships
		int shipMinLength = 3, shipMaxLength = 3; //create ships size 2-4
